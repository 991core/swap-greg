...
export function quote(id = "lifi:quote-a"): NormalizedRoute {
  return { ...params, id, provider: "lifi", toAmount: "900000000000000", toAmountMin: "895500000000000", gasCostUSD: "0.02", durationSeconds: 30, toolLabel: "Bridge", raw: rawRoute(id.replace("lifi:", "")), expiresAt: Date.now() + 60_000 };
}
